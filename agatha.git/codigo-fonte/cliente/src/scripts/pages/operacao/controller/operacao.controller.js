/**
 * Created by Basis Tecnologia on 07/04/2017.
 */
(function(){
    'use strict';
    angular.module('gestaoRiscosApp').controller('OperacaoController', ['$scope', '$mdToast', '$mdDialog', '$q', 'OperacaoService', 'replace-string', controller]);
