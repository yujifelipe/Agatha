...
(function(){
    'use strict';
    angular.module('gestaoRiscosApp').factory('ProcessoService', ['$http', '$q', service]);
    ...
    function service($http, $q){
        ...
        var getProcessoEtapa = function(processoId){
            return $http.get(baseUrl + "/etapa/" + processoId);
        };
        ...
        return {
            ...
            getProcessoEtapa: getProcessoEtapa
        };
    }
})();
